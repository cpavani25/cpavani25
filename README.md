...
· Agente orquestrador com subagentes de delivery, produto, plataforma e arquitetura
· Prompts que transformam refinamentos em regras de negócio e critérios de aceite
· Prompts para análise de métricas ágeis com objetivo de identificar gargalos e definir planos de ação
· [Em andamento] Agentes e skills para contemplar o ciclo de desenvolvimento de ponta a ponta, da ideia ao fechamento do ciclo, com definição de pronto explícita, etapas de revisão e verificação antes da entrega. 


**Formação e Certificações**
· Bacharelado em Ciência da Computação (UEL) 
· MBA em Gerenciamento de Projetos (FGV) 
· MBA em Liderança, Inovação e Gestão 3.0 (PUC-RS) 
· MBA em Gestão de Pessoas (PUC-RS)
· SAFe 4.0 Agilist 
· Management 3.0 
· PACC-P · SFPC · PTFC · PTBC
